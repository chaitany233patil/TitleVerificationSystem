  ...
  return (
    <div className="body min-h-screen bg-gradient-to-br from-blue-100 to-purple-100 px-4 pt-2 pb-9 flex flex-col items-center">
      ...
      <div className="mt-13">
        ...
        >
          ...
          >
            ...
            <div className="flex justify-center">of Your Title in Seconds</div>
          </motion.div>
      ...
      >
        ...
        <button
          onClick={checkTitle}
          className="p-3  px-4 rounded-md bg-gradient-to-r from-pink-500 to-blue-500 text-white font-semibold hover:opacity-90 transition cursor-pointer"
        >
          Check Title
        </button>
      </motion.div>
